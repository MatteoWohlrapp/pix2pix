...
python train.py --dataroot_B /vol/miltank/datasets/CheXpert --csv_path_B /vol/aimspace/projects/practical_SoSe24/mri_inr/matteo/data/CheXpert/chex-metadata.csv --dataroot_A /vol/aimspace/projects/practical_SoSe24/mri_inr/matteo/data/CheXpert_noisy --csv_path_A /vol/aimspace/projects/practical_SoSe24/mri_inr/matteo/data/CheXpert_noisy/chex-metadata_photon_10000.csv --name pix2pix-chex10000 --model pix2pix --dataset_mode chex --direction AtoB --display_freq 250 --print_freq 250 --input_nc 1 --output_nc 1 --use_wandb --batch_size 64 --gpu_ids 0 --netG unet_256 --num_threads 16
